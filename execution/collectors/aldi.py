"""Aldi collector — NOT IMPLEMENTED ON PURPOSE.

Aldi has no licensed price API. Collecting from its website or app is gated on
spec open question 1 (ToS and legal posture). Get a real answer before writing
this. See directives/collect_aldi.md for the contract this collector must meet
...
def collect(db, cfg):
    raise NotImplementedError("Aldi collection is blocked on the ToS/legal review (spec §11 Q1).")
