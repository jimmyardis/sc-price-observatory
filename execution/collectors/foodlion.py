"""Food Lion collector — NOT IMPLEMENTED ON PURPOSE.

Food Lion has no licensed price API. Collecting from its website or app is gated on
spec open question 1 (ToS and legal posture). Get a real answer before writing
this. See directives/collect_foodlion.md for the contract this collector must meet
...
def collect(db, cfg):
    raise NotImplementedError("Food Lion collection is blocked on the ToS/legal review (spec §11 Q1).")
